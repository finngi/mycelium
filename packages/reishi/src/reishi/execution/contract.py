"""Producer-contract types: a Producer is a pure function of a trial's
manifest to its result. Supervision -- heartbeating, claim/reap, retries --
is each executor's own business, not part of this contract.
"""
