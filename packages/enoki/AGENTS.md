...
Depends on [mcm-reishi](https://github.com/Digital-Insight-Technologies-Ltd/mcm-reishi)
...
- [mcm-reishi](https://github.com/Digital-Insight-Technologies-Ltd/mcm-reishi) — the contract layer this repo executes against.
- [mcm-oyster](https://github.com/Digital-Insight-Technologies-Ltd/mcm-oyster) — the other executor (self-hosted mesh, currently `mlx` on Apple Silicon).
